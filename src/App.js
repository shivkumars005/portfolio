      ...
      <section id="projects" className={`${darkMode ? 'text-white' : 'text-dark'} py-5`}>
        <div className="container">
          <div className="text-center mb-5">
            <p className="text-primary fw-bold">MY WORKS</p>
            ...
            {projects.map((project, idx) => (
              <div key={idx} className="col-md-6">
                <a href={project.githubLink} target="_blank" rel="noopener noreferrer" className="text-decoration-none">
                  <div className={`card border-0 rounded-4 h-100 ${darkMode ? 'bg-dark text-light' : 'bg-white shadow-sm'}`} style={{ cursor: 'pointer' }}>
